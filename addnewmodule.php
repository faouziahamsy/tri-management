						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<option value="">--- Choisir un intervenant ---</option>
									...
									while ($row = $managers->fetch_assoc()) :
									?>
										<option value="<?php echo $row['inter2'] ?>" <?php echo isset($inter2) && $inter2 == $row['inter2'] ? "selected" : '' ?>><?php echo ucwords($row['inter2']) ?></option>
									<?php endwhile; ?>
								</select>
							</div>
						</div>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<option value="">--- Choisir un intervenant ---</option>
									...
									while ($row = $managers->fetch_assoc()) :
									?>
										<option value="<?php echo $row['inter3'] ?>" <?php echo isset($inter3) && $inter3 == $row['inter3'] ? "selected" : '' ?>><?php echo ucwords($row['inter3']) ?></option>
									<?php endwhile; ?>
								</select>
							</div>
						</div>
			...
			success:function(resp){
				if(resp == 1 || resp ==2 ){
					...
					setTimeout(function(){
						...
						if  (smstr == '1')  {location.href = 'index.php?page=s1list'}
						if  (smstr == '2')  {location.href = 'index.php?page=s2list'}
						if  (smstr == '3')  {location.href = 'index.php?page=s3list'}
						if  (smstr == '4')  {location.href = 'index.php?page=s4list'}
						if  (smstr == '5')  {location.href = 'index.php?page=s5list'}
					},2000)
				}
			}
		}) 
