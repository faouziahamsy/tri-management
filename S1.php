	...
	<div class="card card-outline card-success">
		...
		<?php if($_SESSION['login_type'] ==1 ||$_SESSION['login_type'] ==4): ?>
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-danger btn-flat border-black" href="./index.php?page=addnewmodule1&semestr=1"><i class="fa fa-plus"></i> Ajouter un module dans S1</a>
			</div>
            <?php endif; ?>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$i = 1;
					$where = "";
					$qry = $conn->query("SELECT * FROM module1,users,semestre2ite WHERE module1.responsable = users.id AND semestre2ite.id_semestre=module1.id_semestre AND code_semestre='S1' ");
