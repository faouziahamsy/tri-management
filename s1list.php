	...
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-danger btn-flat border-black" href="./index.php?page=addnewmodule&semestr=1"><i class="fa fa-plus"></i> Ajouter un module dans S1</a>
			</div>
            <?php endif; ?>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$i = 1;
					$where = "";
					$qry = $conn->query("SELECT * FROM module,users,semestre WHERE module.responsable = users.id AND semestre.id_semestre=module.id_semestre AND code_semestre='S1' ");
