  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Sujet PFE</h5>
      ...
      <div class="modal-body">
			...
			<input type="text" class="form-control" id="sujet" placeholder=" sujet PFE" >
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">Groupe  <span class="text-danger">*</span></label>
			<input type="text" class="form-control" id="groupe" placeholder=" exemple: PFE1" >
        ...
        <button type="button" class="btn btn-danger" data-dismiss="modal">Fermer</button>
			...
			<colgroup>
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * FROM cellule,users WHERE cellule.id_encadrant = users.id  AND cellule.id_cellule=2");
